		...
		<div id="list-productCategory" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="imageURL" title="${message(code: 'productCategory.imageURL.label', default: 'Image URL')}" />
				...
				<g:each in="${productCategoryInstanceList}" status="i" var="productCategoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: productCategoryInstance, field: "imageURL")}</td>
